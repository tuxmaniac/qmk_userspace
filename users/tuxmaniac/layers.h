...
#define LAYER_NAV \
TD(U_TD_BOOT),  U_NA,         U_NA,              TD(U_TD_U_BASE), TD(U_TD_U_GAME),    U_RDO,           U_PST,            U_CPY,           U_CUT,         U_UND,           \
...
#define LAYER_MEDIA \
TD(U_TD_BOOT),  U_NA,         U_NA,              TD(U_TD_U_BASE), TD(U_TD_U_GAME),    UG_TOGG,         UG_NEXT,          UG_VALU,         UG_HUEU,       U_LOCK,          \
